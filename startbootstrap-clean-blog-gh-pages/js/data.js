...
const infoList = [
  {
    ...
    mLeft: '30%',
    name: '평범',
    desc: '질염이 의심되지는 않습니다. 아래에 해당하는 경우에는 산부인과 방문 진료를 권합니다. ',
  ...
  },
  {
    ...
    mLeft: '60%',
    name: '의심',
    desc: '질염이 다소 의심됩니다. 질염은 옷파림 및 생활습관에 많은 영향을 받습니다. 따라서 생활 습관을 바꾸는 것으로도 질염이 나아질 수 있습니다. 하단의 예방법을 보고 생활 습관을 바꿔보는 것을 어떠신가요?',
